...
/**
  ...
  *
  ******************************************************************************
  * sending a string over the UART2 peripheral using DMA mode. The involved steps are:
  ...
  * 	is configured to do a memory-to-peripheral transfer (see Table 9.15)
...
char msg[] = "hola! this message is transferred in DMA mode.\r\n";
/* USER CODE END PV */
