...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : generate a 50Hz pure sine wave
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
  ...
  /**
   * used to generate the Initialization Vector (IV),
   * that is the vector containing the Pulse values used to
   * generate the sine wave (which corresponds to the output
   * voltage levels).
   */
